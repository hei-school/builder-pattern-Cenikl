...
public class Manual {
  ...
  public boolean equals(Object o) {
    ...
    return getSeats() == manual.getSeats()
        && Objects.equals(getEngine(), manual.getEngine())
        && Objects.equals(getTripComputer(), manual.getTripComputer())
        && Objects.equals(getGPS(), manual.getGPS());
  }
  ...
  public Manual(
      Engine engine,
      org.example.Initializer.TripComputer tripComputer,
      org.example.Initializer.GPS gps,
      int seats) {
    this.engine = engine;
